...
(function (window) {
    ...
    //     tweens.forEach(async function(tween) {
    //         tween.tweenTo = mousePos;
    //         //tween.to(mousePos, 800, null, true, 0, -1);
    //     })
    // }
    ...
    opspark.cannon.factory = function (game) {
        ...
        let create = function (type, position, delay) {
            ...
            tween = game.add.tween(projectile).to(tweenTo, 800, null, true, delay || 0, -1);
